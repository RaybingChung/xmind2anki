...
class Courier:
    ...
    backup_dir = dirname(__file__) + sep + 'backup'
    ...
    def set_note_type(self, note_type: str):
        if self.note_type_and_transform_mode_dict.get(note_type) is None:
            raise Exception("There is no this kind of note type.")
        self.transform_function = self.note_type_and_transform_mode_dict[note_type]['transform_function']
        self.deck_name = self.note_type_and_transform_mode_dict[note_type]['deck_name']
