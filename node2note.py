...
def cvt2toefl_independent_writing_note(node: ProcessedNode):
    deck_name = 'test'
    common_phrase_model = '托福-主题-表达'
    common_idea_model = '托福-主题-思路'
    advanced_model = "托福-主题-词组-思路"  # advanced_mode
    tags = ['xmind']
